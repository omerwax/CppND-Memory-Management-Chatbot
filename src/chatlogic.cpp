...
ChatLogic::~ChatLogic()
{
    ...
    // delete all nodes
    // Task 3 - No need to delete _nodes it is now a smart pointer (static allocation) 
    // and will be deleted when ChatLogic goes out of scope
    ...
    // delete all edges
    // Task 4 - _edges are now unique_ptr, no need to delete them
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                           ...
                           // Task 3 - Exclusive ownership -  Adapt lambdas to uniqe_ptr
